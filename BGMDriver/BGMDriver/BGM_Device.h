...
private:
    ...
    #define kDeviceName                 "Loom Background Music"
    #define kDeviceName_UISounds        "Loom Background Music (UI Sounds)"
    #define kDeviceManufacturerName     "Loom Background Music contributors"
